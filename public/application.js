...
var ratingsEvents = __webpack_require__(9);
...
var onSignIn = function onSignIn(event) {
  ...
  authApi.signIn(data).then(authUi.signInSuccess).then(openingGetBrews).catch(authUi.signInFailure);
};
...
// ratings events
var onCreateRating = function onCreateRating(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  authApi.createRating(data).then(authUi.createRatingSuccess).then(getCreatedRating).catch(authUi.createRatingFailure);
};
var getCreatedRating = function getCreatedRating() {
  authApi.getRatings().then(authUi.getMyRatingsSuccess).catch(authUi.getMyRatingsFailure);
};
var onCreateBrew = function onCreateBrew(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  authApi.createBrew(data).then(authUi.createBrewSuccess).catch(authUi.createBrewFailure);
};
var onGetRatings = function onGetRatings(event) {
  event.preventDefault();

  authApi.getRatings().then(authUi.getRatingsSuccess).catch(authUi.getRatingsFailure);
};
var onGetMyRatings = function onGetMyRatings(event) {
  event.preventDefault();
  $('#create-brew-form').hide();
...
var onGetBrews = function onGetBrews(event) {
  event.preventDefault();
  $('#create-brew-form').hide();
  document.getElementById('create-brew-form').reset();
  $('#rate-button').show();
  authApi.getBrews().then(authUi.getBrewsSuccess).catch(authUi.getBrewsFailure);
};

var onUpdateRating = function onUpdateRating(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  // console.log('data is ', data)

  authApi.updateRating(data).then(authUi.updateRatingSuccess).then(onGetMyBrewRatings).catch(authUi.updateRatingFailure);
};
var onDeleteRating = function onDeleteRating(event) {
  event.preventDefault();
  var ratingId = $(event.target).closest('ul').attr('data-id');
  var data = { id: ratingId };
  authApi.deleteRating(data).then(authUi.deleteRatingSuccess).then(onGetMyBrewRatings).catch(authUi.deleteRatingFailure);
};
var onGetMyBrewRatings = function onGetMyBrewRatings() {
  authApi.getRatings().then(authUi.getMyRatingsSuccess).catch(authUi.getMyRatingsFailure);
};
var openingGetBrews = function openingGetBrews() {
  authApi.getBrews().then(authUi.getBrewsSuccess).catch(authUi.getBrewsFailure);
};
var onShowRateForm = function onShowRateForm(event) {
  var brewId = $(event.target).closest('ul').attr('data-id');
  $('#brew-form-' + brewId).show();
  $('.handlebars-form-hidden').hide();
  $('#handlebars-form-hidden-' + brewId).hide();
};
var onShowUpdateRating = function onShowUpdateRating(event) {
  var ratingId = $(event.target).closest('ul').attr('data-id');
  // console.log('clicked', ratingId)
  $('#rating-form-' + ratingId).show();
  $('.handlebars-form-hidden').hide();
  $('.handlebars-form-hidden-' + ratingId).hide();
};
...
// ratings requests
var createRating = function createRating(data) {
...
var createBrew = function createBrew(data) {
  // console.log('data is', data)
  return $.ajax({
    method: 'POST',
...
var getBrews = function getBrews() {
...
var deleteRating = function deleteRating(data) {
  return $.ajax({
    method: 'DELETE',
    url: config.apiUrl + '/ratings/' + data.id,
    headers: {
...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://floating-temple-84056.herokuapp.com',
...
var showRatingsTemplate = __webpack_require__(15);
var showCreateBrewsTemplate = __webpack_require__(32);
...
var createRatingSuccess = function createRatingSuccess(response) {
  // console.log('you created a rating, the respose is ', response)
  // console.log('the store is ', store)
};
var createRatingFailure = function createRatingFailure(response) {
  // console.log('failure, response is ', response)
  $('#rerate-fail').modal();
};
var createBrewSuccess = function createBrewSuccess(response) {
  // console.log('you created a rating, the respose is ', response)
  var showCreateBrewHtml = showCreateBrewsTemplate({ brews: response });
  document.getElementById('create-brew-form').reset();
...
var getBrewsSuccess = function getBrewsSuccess(response) {
  // console.log('response is', response)
  var showCreateBrewHtml = showCreateBrewsTemplate({ brews: response.brews });
  $('#data-show').html(showCreateBrewHtml);
  $('.add-ratings-form').hide();
  $('#show-brews-button').hide();
  $('#show-my-ratings').show();
};
var getRatingsSuccess = function getRatingsSuccess(response) {
  // console.log('The response is ', response)
  var showRatingsHtml = showRatingsTemplate({ ratings: response.ratings });
  $('#data-show').html(showRatingsHtml);
  $('.update-ratings-form').hide();
};
var getMyRatingsSuccess = function getMyRatingsSuccess(response) {
  // console.log('The response is ', response)
  var data = { ratings: [] };
  ...
  if (data.ratings.length === 0) {
    var newHtml = '<br><h3>You have not rated anything yet</h3>';
    $('#data-show').html(newHtml);
    $('#show-brews-button').show();
    $('#show-my-ratings').hide();
  } else {
    var showRatingsHtml = showRatingsTemplate({ ratings: data.ratings });
    $('#data-show').html(showRatingsHtml);
    $('#show-brews-button').show();
    $('.update-ratings-form').hide();
    $('#show-my-ratings').hide();
...
var showRatingsForm = function showRatingsForm(id) {
  // console.log('id', id)
};
var updateRatingSuccess = function updateRatingSuccess(response) {
  // console.log('response is ', response)
};
var deleteRatingSuccess = function deleteRatingSuccess(response) {
...
module.exports = {
  ...
  createRatingSuccess: createRatingSuccess,
  createRatingFailure: createRatingFailure,
  createBrewSuccess: createBrewSuccess,
  getBrewsSuccess: getBrewsSuccess,
  getRatingsSuccess: getRatingsSuccess,
  getMyRatingsSuccess: getMyRatingsSuccess,
  ...
  showRatingsForm: showRatingsForm
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n\n <!-- Developers, why are we using data-id and not just id? -->\n <div class=\"container-fluid col-sm-4 col-md-4 col-lg-4 list\">\n  <h1 data-id=\""
    ...
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.notes : stack1),{"name":"if","hash":{},"fn":container.program(6, data, 0, blockParams),"inverse":container.program(8, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "</li>\n    <li class=\"handlebars-form-hidden-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\"><button class=\"btn btn-primary btn-block show-rating-to-update\">Update</button></li>\n    <li class=\"handlebars-form-hidden-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\"><button class=\"btn btn-primary btn-block show-rating-to-delete\">Remove</button></li>\n\n\n    <form id=\"rating-form-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"update-ratings-form\">\n      <div class=\"form-group\">\n        <input class=\"form-control handlebars-form-hidden\" name=\"id\" type=\"text\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n      </div>\n      <div class=\"form-group\">\n        <input class=\"form-control handlebars-form-hidden\" name=\"name\" type=\"text\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
    + "\">\n      </div>\n      <div class=\"form-group\">\n        <input class=\"form-control handlebars-form-hidden\" name=\"brewery\" type=\"text\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.brewery : stack1), depth0))
    + "\">\n      </div>\n      <div class=\"form-group\">\n        <input class=\"form-control\" name=\"rating\" type=\"text\" placeholder=\"Rate: 0-5\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.rating : stack1), depth0))
    + "\">\n      </div>\n      <div class=\"form-group\">\n        <input class=\"form-control\" name=\"notes\" placeholder=\"notes\" type=\"text\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.notes : stack1), depth0))
    + "\">\n      </div>\n      <input type=\"submit\" class=\"btn btn-primary btn-block\" value=\"Rate\">\n    </form>\n  </ul>\n</div>\n\n\n\n";
  ...
  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.ratings : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n <div class=\"container-fluid col-sm-4 list\">\n  <h1 data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\"><a class=\"show-brew\"> <small>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
    + "</small></a></h1>\n  <ul data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n    <li>"
    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[0][0]) != null ? stack1.brewery : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "</li>\n    <li id=\"handlebars-form-hidden-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\"><button class=\"btn btn-primary btn-block show-brew-to-rate\">Rate</button></li>\n  </ul>\n\n  <form id=\"brew-form-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"add-ratings-form\">\n    <div class=\"form-group\">\n      <input class=\"form-control handlebars-form-hidden\" name=\"name\" type=\"text\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.brewery : stack1), depth0))
    + " - "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
    + "\">\n    </div>\n    <div class=\"form-group\">\n      <input class=\"form-control handlebars-form-hidden\" name=\"brewery\" type=\"text\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.brewery : stack1), depth0))
    + "\">\n    </div>\n    <div class=\"form-group\">\n      <input class=\"form-control\" name=\"rating\" type=\"text\" placeholder=\"Rate: 0-5\" required>\n    </div>\n    <div class=\"form-group\">\n      <input class=\"form-control\" name=\"notes\" placeholder=\"notes\" type=\"text\">\n    </div>\n    <input type=\"submit\" class=\"btn btn-primary btn-block\" value=\"Rate\">\n  </form>\n</div>\n\n";
},"2":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "\n      "
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.brewery : stack1), depth0))
    + "\n";
},"4":function(container,depth0,helpers,partials,data) {
    return "    brewery\n    ";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.brews : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"useData":true,"useBlockParams":true});
